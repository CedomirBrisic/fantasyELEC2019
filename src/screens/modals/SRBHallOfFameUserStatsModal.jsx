...
class SRBHallOfFameUserStatsModal extends React.Component {
    ...
    calculateFirstFive = () => {
        ...
        if (!!userRawDataForSelectedDay[0][this.state.selectedDay] && userRawDataForSelectedDay[0][this.state.selectedDay].Player1Id !== null) {
            ...
            const calculatedPickData = checkEligibilityForPickTeam(this.context.selectedLeague, this.context.fantasyUsers, this.props.userData.username, this.state.selectedDay, this.context.nowDateAndTime, this.context.dropdowns[0].teamsByDay, this.context.basketballPlayers)
            this.setState({
                userDataForSelectedDay,
...
export default SRBHallOfFameUserStatsModal