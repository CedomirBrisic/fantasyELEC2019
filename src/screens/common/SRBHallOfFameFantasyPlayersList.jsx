...
class SRBHallOfFameFantasyPlayersList extends React.Component {
                            ...
                            <table className="w-100">
                                <thead className="w-100">
                                    <tr className="w-100">
                                        ...
                                        <th data-sort-filter-value="freeThrowsFantasy" onClick={this.depositSortFilterValue}><button data-sort-filter-value="freeThrowsFantasy" type="button" className={`btn ${this.state.sortFilterValue === "freeThrowsFantasy" ? "btn-success" : "btn-outline-dark"}`}>Slobodna</button></th>
                                        <th data-sort-filter-value="twoPointsFantasy" onClick={this.depositSortFilterValue}><button data-sort-filter-value="twoPointsFantasy" type="button" className={`btn ${this.state.sortFilterValue === "twoPointsFantasy" ? "btn-success" : "btn-outline-dark"}`}>Dva poena</button></th>
                                        <th data-sort-filter-value="threePointsFantasy" onClick={this.depositSortFilterValue}><button data-sort-filter-value="threePointsFantasy" type="button" className={`btn ${this.state.sortFilterValue === "threePointsFantasy" ? "btn-success" : "btn-outline-dark"}`}>Trojke</button></th>
                                        <th data-sort-filter-value="bonuses" onClick={this.depositSortFilterValue}><button data-sort-filter-value="bonuses" type="button" className={`btn p-0 ${this.state.sortFilterValue === "bonuses" ? "btn-success" : "btn-outline-dark"}`}>Bonusi</button></th>
                                        <th data-sort-filter-value="penalties" onClick={this.depositSortFilterValue}><button data-sort-filter-value="penalties" type="button" className={`btn p-0 ${this.state.sortFilterValue === "penalties" ? "btn-success" : "btn-outline-dark"}`}>Penali</button></th>
                                    </tr>
                                </thead>
...
export default SRBHallOfFameFantasyPlayersList